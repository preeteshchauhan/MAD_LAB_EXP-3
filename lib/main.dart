...
class _ProfilePageState extends State<ProfilePage> {
  String name = "Preetesh Chauhan";
  String email = "...";
  String phone = "XXXXXXXX01";
  String address = "...";
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      children: [
                        ...
                        Text("16 April", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                      ],
                    ),
                    SizedBox(
                      width: 35,
                    ...
                    Column(
                      children: [
                        ...
                        Text("20 yrs", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ],
                ),
